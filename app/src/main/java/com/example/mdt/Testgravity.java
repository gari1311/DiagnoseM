...
public class Testgravity extends AppCompatActivity implements SensorEventListener {
    ...
    ArrayList arrayList;
    String s = "";
    private static final String TAG = "Testgravity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_testgravity);
        ...
        sensorManager.registerListener(Testgravity.this, gravity, SensorManager.SENSOR_DELAY_NORMAL);
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        s = tv.getText().toString()+"\n"+" ✔ "+"Gravity Sensor is working fine"+"\n\n";
    }
