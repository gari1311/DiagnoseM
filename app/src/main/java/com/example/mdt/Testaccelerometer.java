...
public class Testaccelerometer extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_testaccelerometer);
        ...
        sensorManager.registerListener(Testaccelerometer.this, accelerometer, SensorManager.SENSOR_DELAY_NORMAL);
